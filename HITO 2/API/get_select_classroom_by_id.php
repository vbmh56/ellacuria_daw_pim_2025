<?php
    ...
    $Procedimiento = "CALL SELECT_AULA_BY_ID(?)";
    ...
    if ($stmt->execute()) 
    {
        ...
        if ($row = $result->fetch_assoc()) 
        {
            ...
            [
                ...
                "data" =>['ID_DT_AULA' => $row['ID_DT_AULA'],     // Lee la columna ID_DT_AULA.
                          'DS_AULA' => $row['DS_AULA'],           // Lee la columna DS_AULA.
                          'I_CAPACIDAD' => $row['I_CAPACIDAD'],   // Lee la columna I_CAPACIDAD.
                          'DS_UBICACION' => $row['DS_UBICACION']]  // Lee la columna I_CAPACIDAD
            ];
