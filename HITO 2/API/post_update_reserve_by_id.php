<?php
    ...
    $required = ['P_ID_DT_RESERVA', 'P_DESDE', 'P_HASTA'];
    ...
    $idDtReserva = $input['P_ID_DT_RESERVA'];
    ...
    $Procedimiento = "CALL UPDATE_RESERVA_BY_ID(?, ?, ?,?)";
    ...
    $stmt->bind_param("isss",$idDtReserva, $dsReserva, $fedesde, $fehasta);
