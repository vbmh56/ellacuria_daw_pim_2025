<?php
    ...
    $required = ['P_ID_DT_AULA', 'P_DS_AULA', 'P_I_CAPACIDAD', 'P_DS_UBICACION'];
    ...
    $idDtAula   = $input['P_ID_DT_AULA'];
    $dsAula     = $input['P_DS_AULA'];
    $iCapacidad = $input['P_I_CAPACIDAD'];
    $dsUbicacion= $input['P_DS_UBICACION'];

    // Guarda el nombde del procedimiento almacenado que ejecuta esta API.
    $Procedimiento = "CALL UPDATE_AULAS_BY_ID(?, ?, ?,?)";
    ...
    $stmt->bind_param("isis",$idDtAula, $dsAula, $iCapacidad, $dsUbicacion);
